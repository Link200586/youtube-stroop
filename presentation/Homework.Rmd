...
First we need to load the politics data.
```{r}
...
I'd like to find the minimum, mean, and median incomes.
...
To see whether male and females have different optimism scores
before watching *AFHV* we can run an independent t-test.
...
unique instructor thinks I need the practice. Oh, shoot. I
...
and sex doesn't explain any variance, R^2 = .014, F(2, 63) = .44,
p = .65. Despite this lack of significance, I'm creating a
scatter plot because my fabulous instructor thinks that practice
makes perfect.
